...
<head>
  ...
  <style>
    ...
    .shadow-soft { box-shadow: 0 10px 30px -12px rgba(0,0,0,.12); }
...
<body class="text-dark">
  ...
  <nav class="navbar navbar-light bg-white glass border-bottom py-3 sticky-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="d-flex gap-2">
        <a href="/admin" class="btn btn-dark rounded-pill">
          Masuk Dashboard
  ...
  <section class="py-5 text-center">
    <div class="container">
      ...
      <!-- BADGE sesuai contohmu -->
      <div class="d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill"
           style="background-color:#e0f0ff; color:#2563eb; font-weight:600; font-size:.95rem;">
      ...
      <p class="text-muted mx-auto" style="max-width:780px">
        ...
        Tingkatkan produktivitas dan transparansi organisasi Anda.
      </p>
  ...
  <section id="fitur" class="py-4">
    <div class="container">
      ...
      <div class="rounded-4 p-5 mt-4 text-center text-white"
        ...
        <a href="/admin" class="btn btn-light rounded-pill px-4">
